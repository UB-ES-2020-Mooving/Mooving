<template>
  <div id="app" style="margin-top: 0">
   <div>
      <b-navbar toggleable type="dark" variant="dark" v-if="motorbikes.length>0">
        <b-navbar-brand href="#">
        ...
        <b-collapse id="navbar-toggle-collapse" is-nav>
          <b-navbar-nav class="ml-auto">
            <b-nav-item><router-link :to="{path: '/motospagemechanic', query: { email: this.email } }">Motos</router-link></b-nav-item>
